# Syft and Grype scanner
- This tool leverages [_Syft_] (https://github.com/anchore/syft/) and [_Grype_] (https://github.com/anchore/grype)
- It is a simple script that creates a Software Bill of Materials (SBOM) and executes a scan against it using Grype. It handles installing Syft and Grype as well.
